...
class LifeModeScreen  extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    ...
    return _LifeModeScreen();
  }

}

class _LifeModeScreen extends State<LifeModeScreen>{
  ...
  Widget mainContainer(){
    return isLoading ? new Container(margin: EdgeInsets.only(top: SizeConfig.blockSizeVertical * 20),width: SizeConfig.blockSizeHorizontal * 10,height: SizeConfig.blockSizeHorizontal * 10, child:CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Colors.pinkAccent),)) : Container(
      margin: EdgeInsets.only(top: SizeConfig.blockSizeVertical * 5),
      child:  Material(
          ...
          Container(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.accessibility_new_sharp, color: Colors.pinkAccent,),
                  Container(
                    margin: EdgeInsets.only(left: SizeConfig.blockSizeHorizontal * 2),
                    child: Text(
                      "$life",
                      style: Styles.textStyleLabel13Life,
                    ),
                  )
                ],
              ),
